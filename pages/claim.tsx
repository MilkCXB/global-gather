...
import bgLargeH5 from '@/public/images/bg-large.png'
        ...
        <Container>
          ...
          >
            ...
            >
              ...
              <Stack direction={'row'} spacing={2} alignItems={'center'} sx={{ mt: { xs: '20px', sm: '40px' } }}>
                <Stack spacing={2}>
              ...
              {approveState == ApproveState.NOT_APPROVED ? (
                <Grid container spacing={2} sx={{ mt: { xs: '12px', sm: '32px' } }}>
                  <Grid item xs={12} sm={6}>
                    <RecolorfulButtonWrapper>
                      <Button
                        sx={{ backgroundColor: theme.palette.common.black, width: '100%' }}
                        onClick={handleApprove}
                      >
                        <Typography sx={{ color: theme.palette.primary.contrastText }}>Approve</Typography>
                      </Button>
                    </RecolorfulButtonWrapper>
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <RecolorfulButtonWrapper>
                      <Button sx={{ backgroundColor: 'transparent', width: '100%' }} onClick={handleClaim}>
                        <Typography sx={{ color: theme.palette.primary.contrastText }}>Claim</Typography>
                      </Button>
                    </RecolorfulButtonWrapper>
                  </Grid>
                </Grid>
                ...
                <Grid container spacing={2} sx={{ mt: { xs: '12px', sm: '32px' } }}>
                  <Grid item xs={12} sm={6}>
                    <RecolorfulButtonWrapper>
                      <Button sx={{ backgroundColor: theme.palette.common.black, width: '100%' }} disabled={true}>
                        <Typography sx={{ color: theme.palette.primary.contrastText }}>Approving...</Typography>
                      </Button>
                    </RecolorfulButtonWrapper>
                  </Grid>
                  <Grid item xs={12} sm={6}>
              ...
              <Stack spacing={1}>
                <Stack
                  ...
                  spacing={1}
                  alignItems={'center'}
                  sx={{ color: theme.palette.grey[600], mt: { xs: '20px', sm: '40px' } }}
                >
                  <Icon icon={'ic:outline-calculate'} />
                  <Typography>Reward calculation</Typography>
                </Stack>
                <Typography>Personal Rewards = Personal Gas / Total Gas x Total Rewards</Typography>
              </Stack>
            </Card>
          </Box>
        </Container>
